...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto prose prose-sm sm:prose-base lg:prose-lg xl:prose-xl dark:prose-invert">
      <h1 className="text-3xl font-bold text-foreground mb-6">Privacy Policy</h1>
      <p className="text-sm text-muted-foreground mb-8">Effective Date: {currentYear}</p>
        ...
        <ol className="list-decimal list-outside space-y-2 pl-5">
          <li>
            ...
            <ul className="list-disc list-outside space-y-1 pl-5 mt-1">
              ...
              {/* Removed phone number and billing info as less likely for a portfolio */}
            </ul>
          </li>
          <li>
        ...
        <ol className="list-decimal list-outside space-y-2 pl-5">
          ...
          <li>
            ...
            <ul className="list-disc list-outside space-y-1 pl-5 mt-1">
              ...
              {/* Removed promotional offers/newsletters unless planned */}
            </ul>
          </li>
          <li>
      ...
      <section className="space-y-4 mb-8">
        <h2 className="text-xl font-semibold text-foreground">How We Share Your Information</h2>
        ...
        <ol className="list-decimal list-outside space-y-2 pl-5">
          ...
          <li>
            ...
            <p>
              In the event of a merger, acquisition, or sale of assets related to this website, your information may be transferred as part of the business transaction. (Less likely for a personal portfolio, but a standard clause).
            </p>
          </li>
          <li>
      ...
      <section className="space-y-4 mb-8">
        <h2 className="text-xl font-semibold text-foreground">Your Privacy Choices</h2>
        ...
        <ol className="list-decimal list-outside space-y-2 pl-5">
          ...
          <li>
            ...
            <p>
              If you receive any communications from us you wish to stop, you can opt-out by replying to the communication or contacting us directly. (Mainly relevant if you send newsletters).
            </p>
          </li>
          <li>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc list-outside space-y-1 pl-5">
          ...
          {/* Address is optional for a personal portfolio */}
          {/* <li>Address: [Your Address, if applicable]</li> */}
        </ul>
      </section>
    </div>
  );
